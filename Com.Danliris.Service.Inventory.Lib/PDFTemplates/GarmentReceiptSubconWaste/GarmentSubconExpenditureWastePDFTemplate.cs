...
namespace Com.Danliris.Service.Inventory.Lib.PDFTemplates.GarmentReceiptSubconWaste
{
    public class GarmentSubconExpenditureWastePDFTemplate
    {
        public MemoryStream GeneratePdfTemplate(GarmentSubconExpenditureWasteProductionViewModel viewModel)
        {
            const int MARGIN = 20;
            var timeoffset = 7;
