        ...
        public async Task<int> CreateAsync(GarmentLeftoverWarehouseExpenditureAccessories model)
        {
            using (var transaction = DbContext.Database.CurrentTransaction ?? DbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //Create Log History
                    logHistoryService.CreateAsync("GUDANG SISA", "Create Pengeluaran Gudang Sisa Accessoris - " + model.ExpenditureNo);
        ...
        public async Task<int> DeleteAsync(int id)
        {
            using (var transaction = DbContext.Database.CurrentTransaction ?? DbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //Create Log History
                    logHistoryService.CreateAsync("GUDANG SISA", "Delete Pengeluaran Gudang Sisa Accessoris - " + model.ExpenditureNo);
        ...
        public async Task<int> UpdateAsync(int id, GarmentLeftoverWarehouseExpenditureAccessories model)
        {
            using (var transaction = DbContext.Database.CurrentTransaction ?? DbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //Create Log History
                    logHistoryService.CreateAsync("GUDANG SISA", "Update Pengeluaran Gudang Sisa Accessoris - " + model.ExpenditureNo);
