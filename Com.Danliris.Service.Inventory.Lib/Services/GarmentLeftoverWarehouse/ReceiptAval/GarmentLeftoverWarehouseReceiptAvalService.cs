        ...
        public async Task<int> CreateAsync(GarmentLeftoverWarehouseReceiptAval model)
        {
            ...
            using (var transaction = DbContext.Database.CurrentTransaction ?? DbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //Create Log History
                    logHistoryService.CreateAsync("GUDANG", "Create Penerimaan Gudang Sisa Aval - " + model.AvalReceiptNo);
        ...
        public async Task<int> UpdateAsync(int id, GarmentLeftoverWarehouseReceiptAval model)
        {
            ...
            using (var transaction = DbContext.Database.CurrentTransaction ?? DbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //Create Log History
                    logHistoryService.CreateAsync("GUDANG", "Update Penerimaan Gudang Sisa Aval - " + model.AvalReceiptNo);
        ...
        public async Task<int> DeleteAsync(int id)
        {
            ...
            using (var transaction = DbContext.Database.CurrentTransaction ?? DbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    //Create Log History
                    logHistoryService.CreateAsync("GUDANG", "Delete Penerimaan Gudang Sisa Aval - " + model.AvalReceiptNo);
