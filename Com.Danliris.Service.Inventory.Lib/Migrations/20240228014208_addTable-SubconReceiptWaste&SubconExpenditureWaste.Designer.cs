...
namespace Com.Danliris.Service.Inventory.Lib.Migrations
{
    ...
    [Migration("20240228014208_addTable-SubconReceiptWaste&SubconExpenditureWaste")]
    partial class addTableSubconReceiptWasteSubconExpenditureWaste
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ExpenditureWaste.GarmentSubconExpenditureWasteProductionItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("GarmentExpenditureWasteId");

                    b.Property<int>("GarmentReceiptWasteId");

                    b.Property<string>("GarmentReceiptWasteNo")
                        .HasMaxLength(25);
                    ...
                    b.HasIndex("GarmentExpenditureWasteId");

                    b.ToTable("GarmentSubconExpenditureWasteProductionItems");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ExpenditureWaste.GarmentSubconExpenditureWasteProductions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTimeOffset?>("BCOutDate");

                    b.Property<string>("BCOutNo")
                        .HasMaxLength(25);

                    b.Property<string>("BCOutType")
                        .HasMaxLength(25);
                    ...
                    b.Property<string>("GarmentExpenditureWasteNo")
                        .IsRequired()
                        .HasMaxLength(25);
                    ...
                    b.HasIndex("GarmentExpenditureWasteNo")
                        .IsUnique()
                        .HasFilter("[_IsDeleted]=(0)");

                    b.ToTable("GarmentSubconExpenditureWasteProductions");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ReceiptWaste.GarmentSubconReceiptWasteProductionItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("GarmentReceiptWasteId");

                    b.ToTable("GarmentSubconReceiptWasteProductionItems");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ReceiptWaste.GarmentSubconReceiptWasteProductions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("GarmentReceiptWasteNo")
                        .IsUnique()
                        .HasFilter("[_IsDeleted]=(0)");

                    b.ToTable("GarmentSubconReceiptWasteProductions");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ExpenditureWaste.GarmentExpenditureWasteProductionItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GarmentExpenditureWasteProductionItems");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ExpenditureWaste.GarmentExpenditureWasteProductions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GarmentExpenditureWasteProductions");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ReceiptWaste.GarmentReceiptWasteProductionItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GarmentReceiptWasteProductionItems");
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ReceiptWaste.GarmentReceiptWasteProductions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GarmentReceiptWasteProductions");
                });
            ...
            modelBuilder.Entity("com.Danliris.Service.Inventory.Lib.Models.LogHistory.LogHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ExpenditureWaste.GarmentSubconExpenditureWasteProductionItems", b =>
                {
                    b.HasOne("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ExpenditureWaste.GarmentSubconExpenditureWasteProductions", "GarmentSubconExpenditureWasteProductions")
                        .WithMany("Items")
                        .HasForeignKey("GarmentExpenditureWasteId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ReceiptWaste.GarmentSubconReceiptWasteProductionItems", b =>
                {
                    b.HasOne("Com.Danliris.Service.Inventory.Lib.Models.GarmentReceiptSubconWasteProduction.ReceiptWaste.GarmentSubconReceiptWasteProductions", "GarmentSubconReceiptWasteProductions")
                        .WithMany("Items")
                        .HasForeignKey("GarmentReceiptWasteId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ExpenditureWaste.GarmentExpenditureWasteProductionItems", b =>
                {
                    b.HasOne("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ExpenditureWaste.GarmentExpenditureWasteProductions", "GarmentExpenditureWasteProductions")
                        .WithMany("Items")
                        .HasForeignKey("GarmentExpenditureWasteId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ReceiptWaste.GarmentReceiptWasteProductionItems", b =>
                {
                    b.HasOne("Com.Danliris.Service.Inventory.Lib.Models.GarmentWasteProduction.ReceiptWaste.GarmentReceiptWasteProductions", "GarmentReceiptWasteProductions")
                        .WithMany("Items")
                        .HasForeignKey("GarmentReceiptWasteId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
