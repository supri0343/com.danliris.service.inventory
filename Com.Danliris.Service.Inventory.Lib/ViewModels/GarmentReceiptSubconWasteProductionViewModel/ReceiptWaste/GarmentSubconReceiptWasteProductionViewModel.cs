...
{
    public class GarmentSubconReceiptWasteProductionViewModel : BasicViewModel, IValidatableObject
    {
        ...
        public List<GarmentSubconReceiptWasteProductionItemViewModel> Items { get; set; }
