...
{
    public class GarmentSubconExpenditureWasteProductionViewModel : BasicViewModel, IValidatableObject
    {
        ...
        public List<GarmentSubconExpenditureWasteProductionItemViewModel> Items { get; set; }
