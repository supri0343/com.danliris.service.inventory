...
{
    public class GarmentSubconReceiptWasteProductions : StandardEntity, IValidatableObject
    {
        ...
        public virtual ICollection<GarmentSubconReceiptWasteProductionItems> Items { get; set; }
