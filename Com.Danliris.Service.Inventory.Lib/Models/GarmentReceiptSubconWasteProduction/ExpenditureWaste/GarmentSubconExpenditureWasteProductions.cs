...
{
    public class GarmentSubconExpenditureWasteProductions : StandardEntity, IValidatableObject
    {
        ...
        public virtual ICollection<GarmentSubconExpenditureWasteProductionItems> Items { get; set; }
